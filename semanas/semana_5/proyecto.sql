...
-- ============================================
-- CONSULTA 1: BETWEEN — corredores en rango de edad
-- ============================================
...
SELECT
    ...
    peso_kg AS peso
FROM corredores
WHERE edad BETWEEN 25 AND 32
ORDER BY edad ASC;

-- ============================================
-- CONSULTA 2: IN — corredores de ciertas nacionalidades
-- ============================================
...
SELECT
    ...
    equipo_id    AS equipo
FROM corredores
WHERE nacionalidad IN ('Española', 'Colombiana', 'Francesa')
ORDER BY nacionalidad, nombre;

-- ============================================
-- CONSULTA 3: LIKE — corredores cuyo nombre contiene "a"
-- ============================================
...
-- ============================================
-- CONSULTA 4: Combinado (BETWEEN + IN + AND)
-- ============================================
...
WHERE edad       BETWEEN 23 AND 30
  AND nacionalidad IN ('Española', 'Belga', 'Danesa')
  AND activo = 1
